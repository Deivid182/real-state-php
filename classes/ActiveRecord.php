...
class ActiveRecord
{
  ...
  public function save()
  {
    ...
    $query = "INSERT INTO properties ($newKeys) VALUES ('$newValues')";
  ...
  public function update() {
    ...
    $query = "UPDATE properties SET " . join(', ', $values) . "WHERE id = '" . self::$db->escape_string($this->id) . "' LIMIT 1";
  ...
  public static function processQuery($query) {
    ...
    while($property = $result->fetch_assoc()) {
      $properties[] = self::createObject($property);
    }
